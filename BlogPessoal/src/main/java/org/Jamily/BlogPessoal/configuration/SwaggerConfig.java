package org.Jamily.BlogPessoal.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("org.Jamily.BlogPessoal.Controller"))
	...
	private static Contact contact() {
		return new Contact("Jamily Melo", "https://github.com/JamilyM", "jamilymelo787@gmail.com");
	}
